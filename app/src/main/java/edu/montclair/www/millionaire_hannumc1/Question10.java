    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        SubButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                RadioGroup radGroup = findViewById(R.id.Q10);
                if(isCorrect(3, radGroup) == 1 ){

                    // display toast
                    String toastDisp = getResources().getString(R.string.Correct);
                    toastDisp = toastDisp + "1000000!";
                    ...
                    // increment the total earned by 1000000
                    earned = earned + 1000000;
